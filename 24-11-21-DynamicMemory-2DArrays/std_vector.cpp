...
int main(void)
{
	...
	data.push_back(200.0987); // size == 6 // size == 6, capacity == 10 (se dobla del inicial)
	data.push_back(300.0987); // size == 7 // size == 7, capacity == 10
	data.push_back(400.0987); // size == 8 // size == 8, capacity == 10
	std::cout << "size: " << data.size() << std::endl;
	std::cout << "capacity: " << data.capacity() << std::endl;
